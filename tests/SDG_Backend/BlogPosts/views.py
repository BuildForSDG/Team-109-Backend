...
from SDG_Backend.BlogPosts.forms import BlogPostForm
...
def create_post():
    ...
    if form.validate_on_submit():
        ...
        blog_post = BlogPost(title=form.title.data,text=form.text.data,youth_id=current_user.id)
...
def update(blog_post_id):
    ...
    blog_post = blog_post = BlogPost.query.get_or_404(blog_post_id)
