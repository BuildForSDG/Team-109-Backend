...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2020 at 12:49 AM
...
CREATE TABLE `youth_profile` (
  ...
  `expectaction` varchar(1000) NOT NULL,
  `refrees` varchar(1000) NOT NULL
...
INSERT INTO `youth_profile` (`surname`, `other_names`, `email`, `password`, `contact_address`, `phone_no`, `state_of_origin`, `lg`, `date_of_birth`, `perm_address`, `field`, `reasons`, `expectaction`, `refrees`) VALUES
('', '', 'team109@buildsdg.com', 'team109', '', 0, '', '', '0000-00-00', '', '', '', '', ''),
('TTL', '', 'admin@buildsdg.com', 'admin', '', 0, '', '', '0000-00-00', '', '', '', '', '');
